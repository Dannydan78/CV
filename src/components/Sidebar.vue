...
<template>
    ...
    <div class="w-1/5 bg-gradient-to-b from-blue-500 to-purple-500 h-100">
        <img class="w-38 h-40 rounded-full mx-auto mt-3" src="images/photo-danny.jpg" alt="Rounded avatar">
